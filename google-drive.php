...
<html>
<head>
<link rel="icon" type="image/png" href="img/drive_small.png" />
<title>Google Drive</title>

<link href="css/google-drive.css" rel="stylesheet" type="text/css"/>
...
<div id="login-box" class="hide">
	<p>Please Access on your google account.</p>
	<button id="btnLogin" onclick="handleAuthClick()" class="button">Access</button>
</div>
<div class="container" center>



<img alt="" src="img/drive_small.png" id="googlelogo"><span>Google Drive</span>
